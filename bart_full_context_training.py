...
train = pd.read_csv('~/dataset/qg_dataset/hotpot_train_fullcontext_v1.1.csv')
# train = train[40001:]
valid = pd.read_csv('~/dataset/qg_dataset/hotpot_dev_distractor_fullcontext_v1.csv')
# valid = valid[:5000]
...
SAVED_MODEL_PATH = "/home2/nirmal/dataset/qg_dataset/model_hotpot_full_context.pth"
TEMP_SAVE_PATH = "/home2/nirmal/dataset/qg_dataset/model_hotpot_full_context.pth"
...
torch.save(model, "/home2/nirmal/dataset/qg_dataset/model_hotpot_full_context_last.pth")
md2 = torch.load("/home2/nirmal/dataset/qg_dataset/model_hotpot_full_context_last.pth")
